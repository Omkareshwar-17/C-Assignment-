...
```
### Output:
![alt text](<Screenshot 2025-12-05 224834.png>)
### 2) `fopen` — `stdio.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 225211.png>)
### 3)`isalpha` — `ctype.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 225305.png>)
### 4) `toupper` — `ctype.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 225503.png>)
### 6)`free` — `stdlib.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 225911.png>)
### 8)`assert` — `assert.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 230218.png>)
...
```
### Output:
![alt text](<Screenshot 2025-12-05 230330.png>)
### 10)`time` — `time.h`
...
```
### Output:
![alt text](<Screenshot 2025-12-05 230419.png>)
